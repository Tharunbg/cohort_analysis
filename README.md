...
This project was inspired by the work of Greg Reda, with the objective of adapting cohort analysis workflows to the context of Elasticsearch and the eland library.

Despite having performed this analysis many times, I find it useful to maintain a clear, step-by-step reference for building cohort analyses using Python and pandas. This documentation serves as a guide for my own recurring projects and as a resource for others in the data science community.

The following sections walk through the definition of cohort analysis, its importance in growth businesses, and a practical implementation using a standard purchase dataset integrated with Elasticsearch.
...
User retention is only one way of using cohorts to look at your business - we could have also looked at revenue retention. That is, the percentage of each cohort's month 1 revenue returning in subsequent periods. User retention is important, but we should not lose sight of the revenue each cohort is bringing in (and how much of it is returning).

## Maintainer

Tharun Kumar Bettadalli Girish is a Data Scientist with over 4 years of professional experience specializing in Python, SQL, PySpark, and Spark. He focuses on building scalable analytical solutions using modern data technologies like Databricks and HDFS.
